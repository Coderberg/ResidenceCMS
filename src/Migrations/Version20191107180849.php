...
final class Version20191107180849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE area CHANGE city_id city_id INT NOT NULL');
        $this->addSql('ALTER TABLE property CHANGE deal_type_id deal_type_id INT NOT NULL, CHANGE city_id city_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE area CHANGE city_id city_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE property CHANGE deal_type_id deal_type_id INT DEFAULT NULL, CHANGE city_id city_id INT DEFAULT NULL');
