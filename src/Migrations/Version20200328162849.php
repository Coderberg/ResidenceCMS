...
final class Version20200328162849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, deal_type_id INT NOT NULL, category_id INT NOT NULL, city_id INT NOT NULL, neighborhood_id INT DEFAULT NULL, metro_station_id INT DEFAULT NULL, district_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, bathrooms_number SMALLINT DEFAULT NULL, bedrooms_number SMALLINT DEFAULT NULL, max_guests SMALLINT DEFAULT NULL, address VARCHAR(255) NOT NULL, latitude VARCHAR(255) DEFAULT NULL, longitude VARCHAR(255) DEFAULT NULL, show_map TINYINT(1) DEFAULT NULL, price INT DEFAULT NULL, price_type VARCHAR(255) DEFAULT NULL, available_now TINYINT(1) DEFAULT NULL, state VARCHAR(255) DEFAULT \'pending\' NOT NULL, published_at DATETIME NOT NULL, priority_number INT NOT NULL, meta_title VARCHAR(255) DEFAULT NULL, meta_description VARCHAR(255) DEFAULT NULL, INDEX IDX_8BF21CDEF675F31B (author_id), INDEX IDX_8BF21CDE2156041B (deal_type_id), INDEX IDX_8BF21CDE12469DE2 (category_id), INDEX IDX_8BF21CDE8BAC62AF (city_id), INDEX IDX_8BF21CDE803BB24B (neighborhood_id), INDEX IDX_8BF21CDEF7D58AAA (metro_station_id), INDEX IDX_8BF21CDEB08FA272 (district_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE property ADD CONSTRAINT IDX_8BF21CDEF675F31B FOREIGN KEY (author_id) REFERENCES user (id)');
