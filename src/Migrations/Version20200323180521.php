 ...
 */
final class Version20200323180521 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_FEF1E9EE989D9B62 ON neighborhood');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FEF1E9EE989D9B62 ON neighborhood (slug)');
    }
}
